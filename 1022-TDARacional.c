...
// A função recebe duas frações (f1, f2) e um operador (+, -, *, /) e retorna o resultado da operação.
...
/* A função recebe dois inteiros e retorna o maior divisor comum entre eles. */
int mdc(int a, int b) {
    return (b == 0) ? a : mdc(b, a % b);
}

/* A função recebe uma fração e retorna a fração na forma irredutível. */
