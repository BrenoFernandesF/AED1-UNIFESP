...
// A função recebe um deque d e um valor e insere o valor na frente do deque
...
// A função recebe um deque d e um valor e insere o valor no final do deque
...
// A função remove o primeiro elemento do deque d
...
// A função remove o último elemento do deque d
