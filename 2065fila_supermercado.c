...
/* A função recebe o endereço para a primeira celula e para a ultima celula de uma fila encadeada e insere um novo elemento no fim da fila*/
...
/* A função recebe o endereço para a primeira celula e para a ultima celula de uma fila encadeada e remove o primeiro elemento da fila*/
...
/* A função rebe um vetor de unfionários do tipo Funcionario, o  */
...
/*
A função recebe o enderço para o inicio e para o fim da fila, um vetor de funcionários, um vetor de tempos dos funcionários, um inteiro N que representa o número de funcionários e retorna o tempo total de processamento da fila.*/
