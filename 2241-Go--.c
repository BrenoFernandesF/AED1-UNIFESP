...
// A função recebe o tamanho do tabuleiro e o tabuleiro e calcula os prefixos de pretas e brancas
...
// A função recebe as coordenadas de dois pontos e um prefixo e retorna a quantidade de pedras entre esses pontos
